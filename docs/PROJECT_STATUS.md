...
**Cập nhật:** 2026-08-01 (CombatTutorial linear gated)  
**Unity scenes:** `CombatPrototype.unity` · `CombatTutorial.unity` · `RunMapPrototype.unity` · hub/VN scenes  
**Log:** [`PROJECT_LOG.md`](PROJECT_LOG.md) · [`LOGGING.md`](LOGGING.md)  
**Tutorial linear:** [`specs/2026-08-01-combat-tutorial-linear-design.md`](superpowers/specs/2026-08-01-combat-tutorial-linear-design.md)
...
| **Planning Window** (dời unit ‖ gán skill) → **Execute** · một nút | ✅ |
| Drag formation + swap ally trong **mọi** cửa sổ planning | ✅ |
| Beat chia đều — Boss Remix 152 BPM · 677 beat · 30 phase (22 beat) · lookahead 3 · intro 12 beat | ✅ |
| Nhạc chạy liên tục, planning chỉ duck + lowpass (Beat Offset Anchor) | ✅ |
...
- [`2026-08-01-uniform-beat-continuous-music.md`](superpowers/plans/2026-08-01-uniform-beat-continuous-music.md) — runtime **landed**, QA checklist [`combat/UNIFORM_BEAT_QA.md`](combat/UNIFORM_BEAT_QA.md)
...
1. **Play Mode QA** uniform beat + nhạc liên tục: [`combat/UNIFORM_BEAT_QA.md`](combat/UNIFORM_BEAT_QA.md) (ưu tiên mục C/D/E).
2. **Playtest Cover:** farm 8 empty S → COVER → 12 beat ×1.25; Prep không regress.
3. Lớp Ren Cover music: chọn track mới khớp Boss Remix rồi bật lại overlay.
4. P0 boss: CORE / MICRO / EYE tags · note degrade.
5. Ally pick Mend/Encore · Ren Cycle Shift redesign (sau).
6. Task 7 prefabs Unit + PartyCard (P2).
7. **Thiên:** Story P1-1.
